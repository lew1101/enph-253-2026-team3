...
#define WAYPOINT_LIST(X)                                                                           \
    ...
    X(POSE_ROCK_SCAN_1, 0.2302f, 0.8366f, 0.0f)                                                    \
    ...
    X(POSE_ROCK_INTER_12, 0.1588f, 0.8366f, 0.0f)                                                  \
    X(POSE_ROCK_SCAN_2, 0.2188f, 1.4733f, 90.0f)                                                   \
    X(POSE_ROCK_PICKUP_2_1, 0.2688f, 1.4533f, 45.0f)                                               \
    X(POSE_ROCK_PICKUP_2_2, 0.1688, 1.5083f, 45.0f)                                                \
    X(POSE_ROCK_INTER_23_1, 0.2978f, 1.4706f, 90.0f)                                               \
    X(POSE_ROCK_INTER_23_2, 0.2978f, 1.4706f, 0.0f)                                                \
    X(POSE_ROCK_SCAN_3, 0.2049f, 1.7950f, 25.0f)                                                   \
    X(POSE_ROCK_PICKUP_3_1, 0.1653f, 1.6368f, 20.0f)                                               \
    X(POSE_ROCK_PICKUP_3_2, 0.1952f, 1.8785f, -15.0f)                                              \
    ...
    X(POSE_ROCK_SCAN_5_TELETUBBY, -0.5264f, 0.2376f, -90.0f)                                       \
    X(POSE_ROCK_PICKUP_5_1, -0.5264f, 0.4076f, 180.0f)                                             \
    X(POSE_ROCK_PICKUP_5_2, -0.3664f, 0.4076f, 180.0f)                                             \
    X(POSE_ROCK_PICKUP_5_3, -0.3664f, 0.2676f, 175.0f)                                             \
    X(POSE_ROCK_SCAN_6, -0.6820f, 0.2623f, 90.0f)                                                  \
    ...
    X(POSE_INTER_ROCK_TOWER, -1.1153f, 0.1675f, 92.0f)                                             \
    ...
    X(POSE_SOLAR_ALIGN, -1.1235f, 0.6880f, 0.0f)                                                   \
    X(POSE_SOLAR_PULL, -1.1235f, 1.4680f, 0.0f)                                                    \
    X(POSE_SOLAR_TURN, -1.1235f, 1.4680f, 90.0f)
